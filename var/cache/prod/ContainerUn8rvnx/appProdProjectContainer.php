...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zwCv3VWRA-', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'phoneshop', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_777378edf950a6bd6a20415739467fc8bd1d4f9553dc013dcd846f529bd64d3c');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('module.upgrade', array(0 => function () {
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, array('autoescape' => 'name', 'debug' => false, 'strict_variables' => false, 'form_themes' => $this->parameters['twig.form.resources'], 'paths' => array(($this->targetDirs[3].'\\app/../src/PrestaShopBundle/Resources/views/Admin/Product') => 'Product', ($this->targetDirs[3].'\\app/../src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm') => 'Twig', ($this->targetDirs[3].'\\app/../src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters') => 'AdvancedParameters', ($this->targetDirs[3].'\\app/../src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters') => 'ShopParameters', ($this->targetDirs[3].'\\app/../modules') => 'Modules'), 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.7.5.0', '%s?%s');
    }
    ...
    protected function getCsaGuzzle_Client_AddonsApiService()
    {
        ...
        (new \Csa\Bundle\GuzzleBundle\DependencyInjection\Configurator\ClientConfigurator(array(0 => ${($_ = isset($this->services['csa_guzzle.subscriber.cache']) ? $this->services['csa_guzzle.subscriber.cache'] : $this->getCsaGuzzle_Subscriber_CacheService()) && false ?: '_'}), NULL))->configure($instance);
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Ru2aPj1VXJtvzGOy98rZ2ndFXh1M5eXwQs3yDDF2eqnGqkBUgRRLId2J')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['prestashop.bundle.routing.converter.routing_cache_key_generator'] = new \PrestaShopBundle\Routing\Converter\RoutingCacheKeyGenerator(array(0 => ($this->targetDirs[3].'/src/PrestaShopBundle/Resources/config/routing/admin')), ${($_ = isset($this->services['prestashop.module_kernel.repository']) ? $this->services['prestashop.module_kernel.repository'] : $this->load('getPrestashop_ModuleKernel_RepositoryService.php')) && false ?: '_'}->getActiveModulesPaths(), 'prod');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Ru2aPj1VXJtvzGOy98rZ2ndFXh1M5eXwQs3yDDF2eqnGqkBUgRRLId2J');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'Ru2aPj1VXJtvzGOy98rZ2ndFXh1M5eXwQs3yDDF2eqnGqkBUgRRLId2J',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2023-12-04',
            'locale' => 'en-US',
            'cookie_key' => 'QPQwNktfmbKhT2cgDkPysqFLQ7O2xN2DizYSZcTug90FfWxopn7vxpbC',
            'cookie_iv' => 'rxDSOU5q',
            'new_cookie_key' => 'def00000415f42a97e82123b5a69b011efd86b84b75a9bf73d3ab0ffab58b5c231a252dfc61b8fdfd6eb504adb9cc1ad9d5eb5342d04183c1900b91ab633ca37786e1394',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'Ru2aPj1VXJtvzGOy98rZ2ndFXh1M5eXwQs3yDDF2eqnGqkBUgRRLId2J',
            ...
            'prestashop.addons.categories' => array(
                440 => array(
                    'id_category' => 440,
                    'order' => 10,
                    'name' => 'Administration',
